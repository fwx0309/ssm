 ...
 * @Author Fwx
 * @Date 2024/4/11 22:55
 * @Version 1.0
 */
@Component
@Aspect //将当前组件标识为切面
public class LoggerAspect {
    @Pointcut("execution(* org.fwx.aop.annotation.*.*(..))")
    public void pointCut(){};

    // @Before("execution(public int org.fwx.aop.annotation.CalculatorImpl.add(int,int))")
    // @Before("execution(* org.fwx.aop.annotation.*.*(..))")
    @Before("pointCut()")
